...
import static com.example.game2048.Widget.NewAppWidget.getNum;
...
import com.example.game2048.Widget.NewAppWidget;
            ...
            try {
                ...
                switch (Config.NUM) {
                    case 3:
                        ...
                        break;
                    case 4:
                        if (Tool.Save_list_score && MainActivity.getMainActivity().getreturnScore() > 500){
                            ContentValues values = new ContentValues();
                            values.put(Tool.Save_Score, MainActivity.getMainActivity().getreturnScore());
                            values.put(Tool.Step_save, Tool.Step);
                            db.insert(Tool.Tabel_name1,null,values);
                        ...
                        break;
                    case 5:
                        if (Tool.Save_list_score && MainActivity.getMainActivity().getreturnScore() > 5000){
                            ContentValues values = new ContentValues();
                            values.put(Tool.Save_Score, MainActivity.getMainActivity().getreturnScore());
                            values.put(Tool.Step_save, Tool.Step);
                            db.insert(Tool.Tabel_name2,null,values);
